...
do
    ...
    --learning_rate 2e-5 \
    --num_train_epochs 1 \
    --num_train_epochs ${EPOCHS[$name]} \
    --logging_steps ${SAVE_STEPS[$name]} \
    --save_steps ${SAVE_STEPS[$name]} \
...
do
    ...
    --batch_size 64   \
    --learning_rate 2e-5 \
    --num_train_epochs ${SPARSITY_EPOCHS[$name]} \
    --logging_steps ${SPARSITYSAVE_STEPS[$name]} \
    --save_steps ${SPARSITYSAVE_STEPS[$name]} \
